...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.slotWriteRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.Slot": {
            ...
            "properties": {
                "dj_confirmation": {
                    "description": "DJConfirmation is the DJ's portal response: \"confirmed\", \"flagged\", or nil\n(no response yet). Pointer so null round-trips as JSON null (US-011).",
                    "type": "string"
                },
                "dj_id": {
                    "type": "string"
